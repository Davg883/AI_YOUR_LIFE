...
import { Shield, HardHat, Truck, Search, ArrowRight, ArrowUpRight, Building2 } from "lucide-react";
...
export default function HubPage() {
    ...
    const tools = [
        ...
        },
        {
            ...
            description: "AI-powered hazard detection and equipment auditing.",
            icon: Truck,
            theme: "amber",
            status: "Live Demo",
            href: "/factory",
        ...
        },
        {
            ...
            description: "AI-powered public consultation analysis and risk detection.",
            icon: Building2,
            theme: "teal",
            status: "Live",
            href: "/planning",
                                ...
                                <div key={tool.id}>
                                    <Link href={tool.href} className="block group h-full">
                                        <div className="h-full p-8 border border-slate-200 rounded-2xl hover:border-slate-300 hover:shadow-lg transition-all duration-300 bg-white flex flex-col relative overflow-hidden">
                                            ...
                                            ${tool.theme === 'amber' ? 'bg-amber-50 text-amber-600 group-hover:bg-white/20 group-hover:text-white' : ''}
                                            ${tool.theme === 'teal' ? 'bg-teal-50 text-teal-600 group-hover:bg-white/20 group-hover:text-white' : ''}
                                        `}>
                                                    <Icon size={28} />
                                                </div>
